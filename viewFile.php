...
if(!file_exists('Database//' . $filename)) {
	echo "<p><a href='iathena.physics.wmich.edu'>Home</a><br>ERROR: File not found: " . $filename . "</p>";
	exit(1);
...
$arg1 = "viewFile";
echo shell_exec("java -jar AtomPyServer.jar $arg1 $Z $N $SheetNum $BackupArg 2>&1");
?>