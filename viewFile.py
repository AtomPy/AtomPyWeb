...
webpage += '<form action="viewFile.php" method="get">File Version: <select name="BackupArg">'
...
#Selection of sheets
webpage += '<form action="viewFile.php" method="get">Select Sheet: <select name="SheetNum">'
